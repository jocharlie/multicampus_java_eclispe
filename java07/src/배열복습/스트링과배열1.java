...
public class 스트링과배열1 {
	...
	public static void main(String[] args) {
		...
		String s = "나는 프로그래머프야";
		String s2 = "진짜!!";
		System.out.println(s.concat(s2));  //결과는 String 
		System.out.println(s.charAt(0));
		char c = s.charAt(0); // 한 문자만 추출
		System.out.println(s.endsWith("야")); //true/false
		boolean result = s.endsWith("야");
		String result2 = s.substring(3); //인덱스 3부터 끝까지 추출해와라 =>프로그래머프야!
		String result3 = s.substring(3, 8); //인덱스 3부터 7번까지 추출해와라 =>프로그래머프야!
